import 'package:handshake_flutter/src/models/networks.dart';
import 'package:handshake_flutter/src/payments/index.dart' show PaymentData;
import 'package:handshake_flutter/src/payments/p2pkh.dart';
...
void main() {
  group('handshake-dart (BIP32)', () {
    ...
    test('can create a BIP32, handshake, account 0, external address', () {
      const path = "m/0'/0/0";
    ...
    test('can create a BIP44, handshake, account 0, external address', () {
      final root = bip32.BIP32.fromSeed(HEX.decode(
          'dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd'));
    ...
    /* TODO Support BIP49
    test('can create a BIP49, handshake testnet, account 0, external address', () {
    }); */
