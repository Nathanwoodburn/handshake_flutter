...
main() {
  group('handshakejs-lib (transactions)', () {
    test('can create a 1-to-1 Transaction', () {
      ...
      // prepare for broadcast to the handshake network, see 'can broadcast a Transaction' below
    ...
    test('can create an OP_RETURN Transaction', () {
      ...
      txb.addInput(
          '61d520ccb74288c96bc1a2b20ea1c0d5a704776dd0164a396efec3ea7040349d',
          0); // Alice's previous transaction output, has 15000 satoshis
      txb.addOutputData('Hey this is a random string without handshakes');
